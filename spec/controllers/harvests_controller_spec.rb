...
RSpec.describe HarvestsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all harvests as @harvests" do
      ...
      expect(assigns(:harvests)).to eq([harvest])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested harvest as @harvest" do
      harvest = Harvest.create! valid_attributes
      get :show, params: {id: harvest.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested harvest as @harvest" do
      harvest = Harvest.create! valid_attributes
      get :edit, params: {id: harvest.to_param}, session: valid_session
      expect(assigns(:harvest)).to eq(harvest)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Harvest" do
        expect {
          post :create, params: {harvest: valid_attributes}, session: valid_session
      ...
      it "redirects to the created harvest" do
        post :create, params: {harvest: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Harvest.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved harvest as @harvest" do
        post :create, params: {harvest: invalid_attributes}, session: valid_session
        expect(assigns(:harvest)).to be_a_new(Harvest)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested harvest" do
        harvest = Harvest.create! valid_attributes
        put :update, params: {id: harvest.to_param, harvest: new_attributes}, session: valid_session
        harvest.reload
      ...
      it "assigns the requested harvest as @harvest" do
        harvest = Harvest.create! valid_attributes
        put :update, params: {id: harvest.to_param, harvest: valid_attributes}, session: valid_session
        expect(assigns(:harvest)).to eq(harvest)
      end
      ...
      it "redirects to the harvest" do
        harvest = Harvest.create! valid_attributes
        put :update, params: {id: harvest.to_param, harvest: valid_attributes}, session: valid_session
        expect(response).to redirect_to(harvest)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the harvest as @harvest" do
        harvest = Harvest.create! valid_attributes
        put :update, params: {id: harvest.to_param, harvest: invalid_attributes}, session: valid_session
        expect(assigns(:harvest)).to eq(harvest)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested harvest" do
      harvest = Harvest.create! valid_attributes
      expect {
        delete :destroy, params: {id: harvest.to_param}, session: valid_session
      }.to change(Harvest, :count).by(-1)
    end
